...
<!-- 
 ...
 <script type="text/javascript">
                  ...
                  // 주소로 좌표를 검색합니다
                  geocoder.addressSearch('${vo1.address}${vo1.detailAddress}',
                              function(result, status) {
                                 ...
                                 if (status === kakao.maps.services.Status.OK) {
                                    ...
                                    var infowindow = new kakao.maps.InfoWindow(
                                          {
                                             content : '<div style="width:150px;text-align:center;padding:6px 0;font-size:14px">${vo1.restaurantName}</div>'
                                          });
                                    infowindow.open(map, marker);
