...
<div id="reviewpicBox">  <!-- 사진 등록 할 박스 -->

<div class="picsBox">
<input class="pics" type="file">
</div>
<div class="picsBox">
<input class="pics" type="file">
</div>
...
<div>
 	...
 	<form action="./add" class="mb-3" name="myform" id="myform" method="post">
	<fieldset>
	...
	<div>
		<textarea name="contents" class="col-auto form-control" type="text" id="reviewContents"
