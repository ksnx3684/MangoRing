      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-end justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            <h1 class="mb-2 bread">Write Review</h1>
            <p class="breadcrumbs"><span class="mr-2"><a href="../">Home <i class="ion-ios-arrow-forward"></i></a></span> <span>Write Review <i class="ion-ios-arrow-forward"></i></span></p>
          </div>
        </div>
      </div>
    </section>
		...
		<div class="container">
			<div class="row d-flex align-items-stretch no-gutters">
				<div class="col-md-6 p-5 order-md-last">
					<h2 class="h4 mb-5 font-weight-bold">Write Review</h2>
					...
					<form action="./add" class="mb-3" name="myform" id="myform"
						...
						<div class="form-group">
							<div class="col-md-6 d-flex align-items-stretch"
								...
								<div id="reviewpicBox">
									<!-- 사진 등록 할 박스 -->
									<button id="clcl" class="btn-primary disabled" type="button">사진 추가</button>
						...
						<div class="form-group">
							<textarea name="contents" id="reviewContents" cols="30" rows="7"
