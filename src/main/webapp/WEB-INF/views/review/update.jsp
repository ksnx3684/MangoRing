		...
		<div class="container">
			<div
				...
				<div class="col-md-9 ftco-animate text-center">
					<h1 class="mb-2 bread">Update Review</h1>
					<p class="breadcrumbs">
		...
		<div class="container">
			<div class="row d-flex align-items-stretch no-gutters">
				<div class="col-md-6 p-5 order-md-last">
					<h2 class="h4 mb-5 font-weight-bold">update Review</h2>
					...
					<label for="rate5">★</label>
						...
						<div class="form-group">
							<textarea name="contents" id="reviewContents" cols="30" rows="7"
								class="form-control" placeholder="${vo.contents}"></textarea>
						
						<input name="reviewNum" type="hidden" value="${vo.reviewNum }">
